...
COMANDOS = ['java -jar Mars_cache.jar seleccion_testing.asm pa input/CP_{0}.txt output/OP_{1}_{2}.txt','java -jar Mars_cache.jar mezcla_testing.asm pa input/CP_{0}.txt output/OP_{1}_{2}.txt','java -jar Mars_cache.jar mezcla_arreglos_testing.asm pa input/CP_{0}.txt output/OP_{1}_{2}.txt','java -jar Mars_cache.jar mezcla_arreglos_hipotesis_testing.asm pa input/CP_{0}.txt output/OP_{1}_{2}.txt']
...
#Entrada: num_pruebas, número de pruebas a realizar
#           min,numero entero minimo
#           max, numero entero maximo
...
if len(sys.argv) == 5:
    ...
    print 'Faltan o sobran argumentos\n\t python fuzzy.py [CANTIDAD_PRUEBAS_A_GENERAR] [MIN_ELEMENTO_LISTA] [MAX_ELEMENTO_LISTA] [TAMANO_LISTA]\n'
